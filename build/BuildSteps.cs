...
namespace Build
{
    public static class BuildSteps
    {
        ...
        public static void DownloadTemplates()
        {
            ...
            string templatesZipUri = $"https://functionscdn.azureedge.net/public/ExtensionBundleTemplates/ExtensionBundle.v1.Templates.{BundleConfiguration.Instance.TemplateVersion}.zip";
