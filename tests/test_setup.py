...
def webhost(c, clean=False, webhost_version=None, webhost_dir=None,
    ...
    zip_path = download_core_tools(version=webhost_version, func_runtime_version=func_runtime_version) # Download the latest Azure Functions Core Tools
...
def _start_mock_server(temp_dir, port=3000):
    ...
    try:
        ...
        print(f"Index URL: http://localhost:{port}/ExtensionBundles/Microsoft.Azure.Functions.ExtensionBundle/index.json")
