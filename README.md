...
1. Identify the bundle version you want to update and checkout the corresponding branch
    ...
    |------|------|
    | v1.x | http://github.com/Azure/azure-functions-extension-bundles/tree/v1.x |
    | v2.x | http://github.com/Azure/azure-functions-extension-bundles/tree/v2.x |
    | v3.x | http://github.com/Azure/azure-functions-extension-bundles/tree/v3.x |
    | v3.x-preview | http://github.com/Azure/azure-functions-extension-bundles/tree/v3.x-preview |
    | v4.x-preview | http://github.com/Azure/azure-functions-extension-bundles/tree/v4.x-preview |
...
- Follow the steps mentioned at the link below to add a template to extension bundle.
  - http://github.com/Azure/azure-functions-templates#adding-a-template-to-extension-bundle

- Also follow the steps mentioned at the link below to test templates added to extension bundle
  - http://github.com/Azure/azure-functions-templates#testing-script-type-template-via-core-tools
...
the rights to use your contribution. For details, visit http://cla.microsoft.com.
